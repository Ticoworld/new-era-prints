...
const ContestantPageComponent = ({ user }) => {
  ...
  const inviteLink = `http://localhost:5173/invite/${user.username}`;
        ...
        <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-4">
              <img
                src={user ? `http://localhost:3000/${user.profilePic}` : "/src/images/contestant.png"}
          ...
          <div className="mt-8">
            ...
            <p className="text-gray-700">
              Total Voters: {/* Calculate total voters here */} | Total Votes: {/* Calculate total votes here */}
            </p>
            <div className="mt-4">
